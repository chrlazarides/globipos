...
- [History reconciliation completion](history-reconciliation-completion.md) — completion rebases can flatten merge ancestry unless the maintained base already includes the reconciled graph
