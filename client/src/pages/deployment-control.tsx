...
function customerHostname(slug: string) {
  ...
  return normalized ? `${normalized}.${CUSTOMER_DEPLOYMENT_BASE_DOMAIN}` : "";
}
...
export default function DeploymentControlPage() {
  ...
  const setSlug = (value: string) => setForm(f => {
    ...
    const hostname = customerHostname(slug);
    return {
      ...f,
      slug,
