...
import type { PosLayoutSet, PosLocation } from "@shared/schema";
import { z } from "zod";
...
import { LayoutGrid, Plus, Pencil, Trash2, Loader2, Wand2 } from "lucide-react";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(d => mutation.mutate(d))} className="space-y-4">
        <FormField control={form.control} name="name" render={({ field }) => (
          <FormItem><FormLabel>Layout Name</FormLabel><FormControl><Input {...field} placeholder="Main Checkout Layout" data-testid="input-layout-name" /></FormControl><FormMessage /></FormItem>
        )} />
            ...
            <Card key={layout.id} data-testid={`card-layout-${layout.id}`}>
              ...
              <CardContent className="text-sm space-y-1 text-muted-foreground">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" variant="outline" disabled title="Button designer coming in Phase 2">
                    <Wand2 className="w-3.5 h-3.5 mr-1" />Design
                  </Button>
